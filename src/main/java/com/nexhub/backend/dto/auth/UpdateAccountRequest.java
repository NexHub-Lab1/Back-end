...
public record UpdateAccountRequest(
        @Size(max = 255, message = "El email actual es demasiado largo")
        String currentEmail,

        @Size(max = 100, message = "La contraseña actual es demasiado larga")
        ...
        @Size(max = 255, message = "El nuevo email no puede superar los 255 caracteres")
        String newEmail,
